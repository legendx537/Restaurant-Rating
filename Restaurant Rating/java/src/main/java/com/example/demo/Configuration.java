...
public class Configuration {
            ...
            private final ReviewService reviewService = new ReviewService(reviewRepository , restaurantRepository , userRepository);
            ...
            private final GetReviewsFilterOrderCommand  getReviewsbyRangeCommand = new GetReviewsFilterOrderCommand(reviewService);
            ...
            private void registerCommands(){
                ...
                commandRegistry.registerCommand(CommandKeyword.GET_REVIEWS_FILTER_ORDER_COMMAND.getName(),getReviewsbyRangeCommand);
